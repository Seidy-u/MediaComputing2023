...
void plotFruitData(const vector<FruitPoint>& points, const FruitPoint& testdata, const vector<FruitPoint>& nearestPoints) {
    ...
    double x_min = min_element(allPoints.begin(), allPoints.end(), [](const FruitPoint& a, const FruitPoint& b) {return a.x < b.x;})->x;
    double x_max = max_element(allPoints.begin(), allPoints.end(), [](const FruitPoint& a, const FruitPoint& b) {return a.x < b.x;})->x;
    double y_min = min_element(allPoints.begin(), allPoints.end(), [](const FruitPoint& a, const FruitPoint& b) {return a.y < b.y;})->y;
    double y_max = max_element(allPoints.begin(), allPoints.end(), [](const FruitPoint& a, const FruitPoint& b) {return a.y < b.y;})->y;
    ...
    auto comp = [](const FruitPoint& a, const FruitPoint& b) { return a.x == b.x && a.y == b.y && a.classification == b.classification; };
    for(const auto& point : points) {
        ...
        if (find_if(nearestPoints.begin(), nearestPoints.end(), [&point, comp](const FruitPoint& p) { return comp(p, point); }) != nearestPoints.end()) {
...
vector<FruitPoint> getNearestPoints(const vector<FruitPoint>& points, const FruitPoint& testdata, int k) {
    ...
    auto comp = [](const pair<double, FruitPoint>& a, const pair<double, FruitPoint>& b) { return a.first < b.first; };
